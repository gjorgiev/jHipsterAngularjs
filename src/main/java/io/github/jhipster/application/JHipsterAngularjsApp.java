...
public class JHipsterAngularjsApp {

    private static final Logger log = LoggerFactory.getLogger(JHipsterAngularjsApp.class);

    private final Environment env;

    public JHipsterAngularjsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jHipsterAngularjs.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JHipsterAngularjsApp.class);
